function [ nblcsCell, nblcsNewCell, triangNewSTR ] =dividescalenetrianblocks ...
    ( triangSTR, discontSTR )
%
% Description:
...
%
% The structure of an obtuse scalene triangle, same structure as triangSTR,
...
%
% Example1:
% triangSTR =struct( 'slipSideCell', {{7.7862, 123.4354, [4.0459; 0.6]}}, ...
...
%
%%%%%%%%%%%%%%%%
% [ nblcsCell, nblcsNewCell, triangNewSTR ] =dividescalenetrianblocks ...
%    ( triangSTR, discontSTR, thetaDeg )
%%%%%%%%%%%%%%%%

%% Input management
bsideUnitVec =(triangSTR.crownSlopeCell{3} -triangSTR.baseSlopeCell{3}) ...
   /norm(triangSTR.crownSlopeCell{3} -triangSTR.baseSlopeCell{3});
...
discontDipDeg =discontSTR.dipDeg;
discontSep =discontSTR.separation;

%% Maximum number of blocks
discontSepProj =discontSep *sec( (thetaDeg -90 +discontDipDeg)*pi/180 );
...
bAngleDeg =triangSTR.slipSideCell{2};
aAngleDeg =triangSTR.baseSlopeCell{2};
cAngleDeg =triangSTR.crownSlopeCell{2};
